...
export const registerReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case REGISTRATION_SUCCESS:
            return { loading: false, is_register: 1 }
        case REGISTRATION_FAIL:
            return { loading: false, is_register: 0 }
