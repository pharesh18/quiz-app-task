...
const { validateUserSchema, registerUser, validateOtpSchema, userOtp, validateUserLogin, userLogin, validateForgetPassword, forgetPassword, validateChangePassword, changePassword, uploadProfile, validateUploadProfile, upload, getAllUsers, validateSetPassword, setPassword } = require('../controller/userController.js');
